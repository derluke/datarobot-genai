...
class LatexSection:
    def __init__(
        ...
        latex_tables: str | dict | None = None,
    ):
...
# def DataRobotModel(Model):
#     def __init__(self, project_id, model_id):
#         self.project_id = project_id
#         self.model_id = model_id
#         self.model = dr.Model.get(self.model_id, self.project_id)

#     def get_feature_importance(self):
#         return self.model.get_feature_importance()

#     def get_feature_effects(self):
#         return self.model.get_feature_effects()

#     def predict(self, data):
#         return self.model.request_predictions(data)
